...
var MultiSelectionProvider = function MultiSelectionProvider(_ref) {
  ...
  var _useState3 = (0, _react.useState)([]),
      ...
      multiSelectionFiles = _useState4[0],
      setMultiSelectionFiles = _useState4[1];
  ...
  var addCurrentMultiSelectionFile = function addCurrentMultiSelectionFile(fileToAdd) {
    setCurrentMultiSelectionFiles(function (files) {
      return [].concat((0, _toConsumableArray2.default)(files), [fileToAdd]);
    });
  };

  var removeCurentMultiSelectionFile = function removeCurentMultiSelectionFile(fileToRemove) {
    setCurrentMultiSelectionFiles(function (files) {
  ...
  var addMultiSelectionFile = function addMultiSelectionFile(fileToAdd) {
    setMultiSelectionFiles(function (files) {
      return [].concat((0, _toConsumableArray2.default)(files), [fileToAdd]);
    });
  };
  ...
  var value = {
    ...
    addCurrentMultiSelectionFile: addCurrentMultiSelectionFile,
    removeCurentMultiSelectionFile: removeCurentMultiSelectionFile
  };
