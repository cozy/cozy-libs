...
exports.harmonizeContactsNames = exports.groupFilesByContacts = exports.buildFilesByContacts = void 0;
...
var getContactsRefIds = function getContactsRefIds(file) {
...
var groupFilesByContacts = function groupFilesByContacts(filesArg, contactsArg) {
  return Object.entries((0, _groupBy.default)(filesArg, getContactsRefIds)).map(function (_ref) {
