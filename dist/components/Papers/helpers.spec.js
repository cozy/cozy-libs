...
describe('helpers Papers', function () {
  describe('getContactsRefIdsByFiles', function () {
    it('should return list of contact ids', function () {
      var res = (0, _helpers.getContactsRefIdsByFiles)(mockFiles);
      expect(res).toStrictEqual(['contactId01', 'contactId02']);
    });
    it('should return empty array if has no param', function () {
      var res = (0, _helpers.getContactsRefIdsByFiles)();
