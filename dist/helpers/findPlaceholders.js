...
var hasNoFileWithSameQualificationLabel = function hasNoFileWithSameQualificationLabel(files, paperDefinition) {
  return files && !files.some(function (paper) {
    ...
    return (paper === null || paper === void 0 ? void 0 : (_paper$metadata = paper.metadata) === null || _paper$metadata === void 0 ? void 0 : (_paper$metadata$quali = _paper$metadata.qualification) === null || _paper$metadata$quali === void 0 ? void 0 : _paper$metadata$quali.label) === paperDefinition.label;
  });
};
/**
