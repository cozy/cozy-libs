...
<a name="1.4.0"></a>
# [1.4.0](https://github.com/cozy/cozy-libs/compare/cozy-realtime@1.2.8...cozy-realtime@1.4.0) (2019-02-07)
...
* **realtime:** :pencil2: Typos in comments to force major release ([7465b71](https://github.com/cozy/cozy-libs/commit/7465b71))
* **realtime:** Use promise instead of polling to handle authenticating ([bdbf440](https://github.com/cozy/cozy-libs/commit/bdbf440))


### BREAKING CHANGES

* **realtime:** To force a major release (previously failed with 1.3.0)
