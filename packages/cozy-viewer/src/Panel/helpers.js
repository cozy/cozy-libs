...
export const metadataByQualificationLabel = {
  ...
  energy_invoice: ['issueDate', 'referencedDate'],
  ...
  isp_invoice: ['issueDate', 'referencedDate'],
  lease: ['date'],
  ...
  other_invoice: ['issueDate', 'referencedDate'],
  ...
  phone_invoice: ['issueDate', 'referencedDate'],
  ...
  transport_invoice: ['issueDate', 'referencedDate'],
  ...
  water_invoice: ['issueDate', 'referencedDate'],
